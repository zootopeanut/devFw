...
<script language="javascript">
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"고객 ID",Type:"Text",SaveName:"cust_id",MinWidth:80,Align:"Center"},
			{Header:"고객 이름",Type:"Text",SaveName:"cust_name",MinWidth:80,KeyField:1 ,MultiLineText:1}, //필수값을 체크하고자 할 때 keyField사용			
			{Header:"고객 주소",Type:"Text",SaveName:"cust_address",MinWidth:150,MultiLineText:1, Wrap:1}, //KeyField는 반드시 입력하고자 하는 값을 설정하고플 때.
			{Header:"고객 주",Type:"Text",SaveName:"cust_state",MinWidth:150},
			{Header:"고객 우편번호",Type:"Text",SaveName:"cust_zip",MinWidth:100},
			{Header:"고객 국가",Type:"Text",SaveName:"cust_country",MinWidth:100},
			{Header:"고객 담당자",Type:"Text",SaveName:"cust_contact",MinWidth:100},
			{Header:"고객 이메일",Type:"Text",SaveName:"cust_email",MinWidth:100},			
